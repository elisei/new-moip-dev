...
/**
 * Class AuthorizeCheckoutCommand - Executes the payment creation command with the order creation call.
 */
class AuthorizeCheckoutCommand implements CommandInterface
{
